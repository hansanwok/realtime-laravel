            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row-item row">
                        <h3>
                            <a href="category.html">{{$row->Ten}}</a> |
                        ...
                        <div class="col-md-8 border-right">
                            ...
                            <div class="col-md-7">
                                <h3>{{$tin1['TieuDe']}}</h3>
                                <p>{{$tin1['TomTat']}}</p>
                                <a class="btn btn-primary" href="tintuc/{{$tin1->id}}/{{$tin1->TieuDeKhongDau}}.html">More <span class="glyphicon glyphicon-chevron-right"></span></a>
                            </div>
